...
```{r, include=FALSE}
# Esto evita que se ejecuten los bloques de código
...
[![R-CMD-check](https://github.com/benjabalsola/paqueteR/actions/workflows/R-CMD-check.yaml/badge.svg)](...)
[![Codecov test coverage](https://codecov.io/gh/benjabalsola/paqueteR/graph/badge.svg)](https://app.codecov.io/gh/benjabalsola/paqueteR)
<!-- badges: end -->
...
- Crear una tabla resumen (`tabla_resumen_temperatura`)
- Generar un gráfico mensual (`grafico_temperatura_mensual`)
...
grafico_temperatura_mensual(
  NH0437,
  titulo = "Promedio mensual NH0437"
)
